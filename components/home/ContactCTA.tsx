...
export default function ContactCTA() {
  return (
    <section className="py-20 bg-pure-black relative overflow-hidden">
      ...
      <div className="circular-overlay bottom-20 right-10 animate-float" style={{ animationDelay: "1.5s" }} />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-card rounded-3xl p-8 md:p-12 text-center">
            ...
            <p className="font-montserrat text-lg text-medium-gray mb-8 max-w-2xl mx-auto">
              Let our expert team help you discover the perfect property that matches your vision and budget. Contact us
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="glass-effect rounded-xl p-6 hover-lift">
                ...
                <h3 className="font-montserrat font-semibold text-light-gray mb-2">Call Us</h3>
                <p className="text-medium-gray text-sm">+91 9810233651</p>
              </div>
              <div className="glass-effect rounded-xl p-6 hover-lift">
                <MessageCircle className="w-8 h-8 text-green-500 mx-auto mb-3" />
                <h3 className="font-montserrat font-semibold text-light-gray mb-2">WhatsApp</h3>
                <p className="text-medium-gray text-sm">Quick Response</p>
              </div>
              <div className="glass-effect rounded-xl p-6 hover-lift">
                <Mail className="w-8 h-8 text-light-gray mx-auto mb-3" />
                <h3 className="font-montserrat font-semibold text-light-gray mb-2">Email</h3>
                <p className="text-medium-gray text-sm">sunilverma3625@gmail.com</p>
              </div>
              <div className="glass-effect rounded-xl p-6 hover-lift">
                <MapPin className="w-8 h-8 text-light-gray mx-auto mb-3" />
                <h3 className="font-montserrat font-semibold text-light-gray mb-2">Visit Us</h3>
                <p className="text-medium-gray text-sm">B-294, Shop No. 4, New Ashok Nagar</p>
              </div>
            </div>
